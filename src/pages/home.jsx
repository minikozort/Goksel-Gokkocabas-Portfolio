...
export default function Home() {
  return (
   ...
   <div id="About-me">
      ...
      <p>
        Feel free to reach out to me at Contactto discuss potential collaborations or opportunities. Let's connect and explore how we can work together to achieve our shared goals and objectives. If you would like to learn more about my project or download my resume, please click on the <a href="#navigation-bar-links">navigation bar links</a>.
      </p>
      <picture>
