export default function About() {
  return (
    <div>
      ...
      <p>
        Feel free to reach out to me at <a href="#Contact-me">Contact</a> to discuss potential collaborations or opportunities. Let's connect and explore how we can work together to achieve our shared goals and objectives. If you would like to learn more about my project or download my resume, please click on the <a href="#navigation-bar-links">navigation bar links</a>.
      </p>
      <picture>
        <img className="img1" src="../../Pics/Headshot.PNG" alt="My Image" />
      </picture>
    </div>
  );
}
